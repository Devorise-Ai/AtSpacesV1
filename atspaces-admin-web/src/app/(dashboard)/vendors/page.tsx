...
const vendors = [
    { id: "1", name: "Mohammed Al-Khatib", email: "m.khatib@email.com", branches: 2, reliability: 94, checkIn: 96, noShow: 2.1, status: "Active", joinedDate: "Jan 2025" },
    { id: "2", name: "Sara Hassan", email: "s.hassan@email.com", branches: 1, reliability: 96, checkIn: 98, noShow: 1.5, status: "Active", joinedDate: "Feb 2025" },
    { id: "3", name: "Ahmad Yousef", email: "a.yousef@email.com", branches: 1, reliability: 91, checkIn: 93, noShow: 3.2, status: "Active", joinedDate: "Mar 2025" },
    { id: "4", name: "Layla Obeidat", email: "l.obeidat@email.com", branches: 1, reliability: 87, checkIn: 89, noShow: 4.8, status: "Active", joinedDate: "Apr 2025" },
    { id: "5", name: "Omar Nabil", email: "o.nabil@email.com", branches: 1, reliability: 72, checkIn: 78, noShow: 8.2, status: "Under Review", joinedDate: "Jun 2025" },
    { id: "6", name: "Dina Masri", email: "d.masri@email.com", branches: 1, reliability: 45, checkIn: 60, noShow: 15.3, status: "Suspended", joinedDate: "Aug 2025" },
];
